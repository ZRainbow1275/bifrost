...
# Constants
# =============================================================================
: "${BIFROST_REPORT_DIR:=/var/log/ai-gateway-bridge}"
...
# _resolve_report_dir()
#
# Resolve a writable report directory. Falls back to a temp directory when the
...
_resolve_report_dir() {
    ...
    local fallback_dir="${TMPDIR:-/tmp}/ai-gateway-bridge"
