#!/usr/bin/env bash
# ==============================================================================
# AI Gateway Bridge - Deep Packet Inspection (DPI) Anti-Detection Module
# ==============================================================================
...
readonly ANTI_DPI_BASE_DIR="/opt/ai-gateway-bridge"
...
readonly ROTATE_CRON_SCRIPT="/opt/ai-gateway-bridge/rotate-dest.sh"
readonly ROTATE_LOG_FILE="/var/log/ai-gateway-bridge-rotate.log"
readonly ANTI_DPI_STATE_DIR="/opt/ai-gateway-bridge/.anti-dpi-state"
...
_generate_default_dest_pool() {
    ...
    cat > "${output}" <<'POOL_EOF'
# ==============================================================================
# AI Gateway Bridge - Reality Destination Pool
# ==============================================================================
...
setup_dest_rotation_cron() {
    ...
    local cron_marker="# ai-gateway-bridge: dest rotation"
...
#!/usr/bin/env bash
# Auto-generated by AI Gateway Bridge anti-dpi module
# Standalone dest rotation script for cron execution
set -euo pipefail

DEST_POOL_FILE="/opt/ai-gateway-bridge/dest-pool.txt"
